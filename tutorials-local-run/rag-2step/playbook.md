...
#     2. Tree of Thoughts (Yao et al. 2023) extends CoT by exploring...
#     3. Chain of thought (CoT; Wei et al. 2022) has become a standard...
#     4. ...
#
# A: Task Decomposition is a technique for breaking complex tasks into
#    smaller, more manageable steps. The standard approach is Chain of
#    Thought (CoT) prompting...
#
# Q: What are the main types of memory in LLM agents?
# ------------------------------------------------------------
#   [Step 1 — Retrieved 4 chunks]
#     1. Memory Types: Sensory memory, short-term memory, long-term memory...
#     2. ...
#
